...
4. [System Architecture](#4-system-architecture)
   ...
   - 4.2 [Data and Control Flow](#42-data-and-control-flow)
   - 4.3 [Module Responsibilities](#43-module-responsibilities)
5. [Hardware](#5-hardware)
   - 5.1 [Component List](#51-component-list)
   - 5.2 [Servo Pin Assignments](#52-servo-pin-assignments)
   - 5.3 [Physical Setup and Workspace](#53-physical-setup-and-workspace)
6. [Software Components](#6-software-components)
   - 6.1 [IK1.ino — Arduino Firmware](#61-ik1ino--arduino-firmware)
   - 6.2 [a4_calibration.py — Camera Calibration Tool](#62-a4_calibrationpy--camera-calibration-tool)
   - 6.3 [finalv1.py — Main Controller Pipeline](#63-finalv1py--main-controller-pipeline)
     - 6.3.1 [Camera Management](#631-camera-management)
     - 6.3.2 [Computer Vision Pipeline](#632-computer-vision-pipeline)
     - 6.3.3 [Speech Recognition](#633-speech-recognition)
     - 6.3.4 [LLM Task Planner](#634-llm-task-planner)
     - 6.3.5 [Inverse Kinematics Solver](#635-inverse-kinematics-solver)
     - 6.3.6 [Arm Controller and Motion Execution](#636-arm-controller-and-motion-execution)
     - 6.3.7 [Main Loop](#637-main-loop)
7. [Mathematical Foundations](#7-mathematical-foundations)
   - 7.1 [Homography and Perspective Transform](#71-homography-and-perspective-transform)
   - 7.2 [Inverse Kinematics Derivation](#72-inverse-kinematics-derivation)
   - 7.3 [Servo Calibration Mapping](#73-servo-calibration-mapping)
8. [Installation](#8-installation)
   - 8.1 [Prerequisites](#81-prerequisites)
   - 8.2 [Python Environment](#82-python-environment)
   - 8.3 [Arduino Firmware](#83-arduino-firmware)
   - 8.4 [Local LLM Setup](#84-local-llm-setup)
9. [Setup and Usage](#9-setup-and-usage)
10. [Configuration Reference](#10-configuration-reference)
    - 10.1 [System Configuration (finalv1.py)](#101-system-configuration-finalv1py)
    - 10.2 [IK and Geometry Constants](#102-ik-and-geometry-constants)
    - 10.3 [Arduino Firmware Parameters](#103-arduino-firmware-parameters)
11. [Design Decisions and Engineering Notes](#11-design-decisions-and-engineering-notes)
...
### 5.3 Physical Setup and Workspace
...
### 6.2 a4_calibration.py — Camera Calibration Tool
...
### 6.3 finalv1.py — Main Controller Pipeline
...
#### 6.3.2 Computer Vision Pipeline
...
#### 6.3.5 Inverse Kinematics Solver
...
#### 6.3.6 Arm Controller and Motion Execution
...
### 7.1 Homography and Perspective Transform
...
### 7.2 Inverse Kinematics Derivation
...
### 10.1 System Configuration (finalv1.py)
...
### 10.2 IK and Geometry Constants
...
### 10.3 Arduino Firmware Parameters
...
## 11. Design Decisions and Engineering Notes
